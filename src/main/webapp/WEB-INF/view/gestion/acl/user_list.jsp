		...
		<form action="/g/acl/add_user" method="post" id="data_Form_add_user"
			...
			<fieldset>
				<label for="email"> 邮箱: </label> <input type="text" name="email"
					id="email" /> </br> <label for="password"> 密码: </label> <input
					type="text" name="password" id="password" /> </br> <label for="roles">角色ids</label>
				<input type="text" name="roles" id="roles" /> </br> <input type="submit"
					value="添加" /> </br> </br>
				<h5>1、角色ids可以写多个，中间用","号隔开</h5>
			</fieldset>
