...
public class Page implements Serializable {
    ...
    public String toString() {
        return "Page [data=" + data + ", firstResult=" + firstResult + ", nextPage=" + nextPage + ", pageIndex=" + pageIndex + ", pageSize=" + pageSize
            + ", previousPage=" + previousPage + ", totalPage=" + totalPage + ", totalResults=" + totalResults + "]";
    }
