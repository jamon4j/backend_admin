...
public class HostController {
    ...
    public ModelAndView returnZoneList(@RequestParam("hostname") String hostName, ModelAndView mav) throws IOException {
        ...
        try {
            ...
            for(ZonePojo zonePojo:zoneList){
                hostPojos.addAll(hostService.getHosts(zonePojo.getId()));
            }
        } catch (ErrorCodeException | NoTokenException e) {
            e.printStackTrace();
        }
