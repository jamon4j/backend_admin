...
public class SecurityService {
    ...
    public List<SecurityPojo> getSecurity(String id,String tenant_id,String Region) throws ErrorCodeException, NoTokenException {
        jsonService.setId(id);
        jsonService.setTenantId(tenant_id);
        List<SecurityPojo> list = jsonService.getPoList(InitConst.KVM_SECURITY_GROUP_LIST, null, null,Region, SecurityPojo.class);
        return list;
    }
    ...
    public void addSecurity(String id,String tenantId,String name,String desc,String Region) throws ErrorCodeException, NoTokenException {
        Map<String,String> map = new HashMap<>();
        map.put("name", name);
        map.put("desc", desc);
        String requestBody = JSONObject.toJSONString(map);
        jsonService.setId(id);
        jsonService.setTenantId(tenantId);
        jsonService.poPost(InitConst.KVM_SECURITY_GROUP_CRATE,null,null,null,Region,requestBody);
    }
    ...
    public void delSecurity(String id,String tenantId,String groupIds,String Region) throws ErrorCodeException, NoTokenException {
        String[] ids = groupIds.split(",");
        jsonService.setId(id);
        jsonService.setTenantId(tenantId);
        for(String gid:ids){
            jsonService.poDelete(InitConst.KVM_SECURITY_GROUP_DELETE,null,null,Region,gid);
        }
    }
    ...
    public SecurityPojo getRules(String id,String tenantId,String groupId,String Region) throws ErrorCodeException, NoTokenException {
        jsonService.setId(id);
        jsonService.setTenantId(tenantId);
        SecurityPojo pojo = jsonService.poGet(InitConst.KVM_SECURITY_GROUP, null, null,Region, SecurityPojo.class, groupId);
        return pojo;
    }
    ...
    public void addRule(String userId,String tenantId,String sgid,String protocal,String fromPort,String toPort,String cidr,String Region) throws ErrorCodeException, NoTokenException {
        jsonService.setId(userId);
        jsonService.setTenantId(tenantId);
        Map<String, String> map = new HashMap<>();
        map.put("group_id", sgid);
        ...
        map.put("cidr", cidr);
        String requestBody = JSONObject.toJSONString(map);
        jsonService.poPost(InitConst.KVM_SECURITY_GROUP_RULE_CREATE, null, null,Region, null, requestBody);
    }
    ...
    public void delRule(String userId,String tenantId,String ruleId,String Region) throws ErrorCodeException, NoTokenException {
        jsonService.setId(userId);
        jsonService.setTenantId(tenantId);
        jsonService.poDelete(InitConst.KVM_SECURITY_GROUP_RULE_DELETE, null, null,Region, ruleId);
    }
}
